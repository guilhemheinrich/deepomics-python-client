...
def api_reactors_replicates_locations_get_subresourceReactorSubresource(
    host
    # Path parameters
       , 
        path_id, path_replicates
    ...
    final_path = "/reactors/{id}/replicates/{replicates}/locations".format(
        id = path_id, replicates = path_replicates
    )
