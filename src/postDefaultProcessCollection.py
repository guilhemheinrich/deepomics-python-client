...
def postDefaultProcessCollection(
    host
    
    
    # Body parameters
       , 
        body_processCategory, body_site, body_siteName, body_siteSlug, body_displayName, body_longSlug, body_canDelete, body_parentSlug, body_parentId, body_events, body_slug, body_project, body_monitoredMeasureTypes, body_measurements, body_id, body_comments, body_name, body_measures
