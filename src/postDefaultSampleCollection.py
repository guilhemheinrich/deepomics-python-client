...
def postDefaultSampleCollection(
    host
    
    
    # Body parameters
       , 
        body_operation, body_operationLabel, body_description, body_type, body_typeLabel, body_comment, body_project, body_locationDetails, body_sequencingSamples, body_sequencingRunSlug, body_displaySampleResults, body_date, body_location, body_operator, body_locationSlug, body_id, body_slug
